...
udp_declaration:
 KW_EXTERN ( udp_nonansi_declaration
  ...
  | ( ( udp_nonansi_declaration udp_port_declaration
      ...
      | udp_ansi_declaration
      ) udp_body KW_ENDPRIMITIVE ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
 ...
 KW_EXTERN interface_header
  | ( ( interface_header
          | ( attribute_instance )* KW_INTERFACE identifier LPAREN DOT MUL RPAREN SEMI
                          ...
                          | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}?
                          )
;
interface_header:
...
action_block:
   ...
   | statement_or_null ( KW_ELSE statement_or_null | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}? )
;
seq_block:
    KW_BEGIN ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
        ( block_item_declaration )* ( statement_or_null )*
    KW_END (COLON identifier |  {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}?);
par_block:
    KW_FORK ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
        ( block_item_declaration )* ( statement_or_null )*
    join_keyword ( COLON identifier |  {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? );
/******************************************** case ********************************************************************/
case_statement:
    ( unique_priority )?
...
conditional_statement:
    ...
    ( KW_ELSE statement_or_null | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}? );
subroutine_call_statement:
...
rs_if_else:
    ...
    ( KW_ELSE production_item | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}? );
rs_repeat:
...
property_expr:
  ...
  | KW_IF LPAREN expression_or_dist RPAREN property_expr ( KW_ELSE property_expr
                                                          | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}?
                                                          )
...
constraint_expression:
    ...
    ( KW_ELSE constraint_set | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}? )
...
module_declaration:
  KW_EXTERN module_header_common ( list_of_port_declarations )? SEMI
   | module_header_common (list_of_port_declarations | (LPAREN DOT MUL RPAREN) )? SEMI
     ...
     KW_ENDMODULE ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
module_keyword:
  KW_MODULE
   | KW_MACROMODULE
...
function_declaration:
    ...
    KW_ENDFUNCTION ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
...
task_declaration:
    KW_TASK ( lifetime )?
	task_and_function_declaration_common
    KW_ENDTASK ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
method_prototype:
    task_prototype
    | function_prototype
...
checker_declaration:
    ...
    KW_ENDCHECKER ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? );
class_declaration:
    ...
    ( class_item )*
    KW_ENDCLASS ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? );
always_construct:
...
package_declaration:
 ...
 ( ( attribute_instance )* package_item )*
  KW_ENDPACKAGE ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}?)
;
package_item:
 net_declaration
  | data_declaration
...
program_declaration:
 KW_EXTERN program_header
  | ( ( program_header
      ...
      ) KW_ENDPROGRAM ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
program_header:
...
if_generate_construct:
    ...
    ( KW_ELSE generate_item | {/*_input->LA(1) != KW_ELSE*/_input.LA(1) != KW_ELSE}? );
case_generate_construct:
...
generate_begin_end_block:
    ( identifier COLON )? KW_BEGIN ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
        ( generate_item )*
    KW_END ( COLON identifier | {/*_input->LA(1) != COLON*/ _input.LA(1) != COLON}? )
;
generate_item:
